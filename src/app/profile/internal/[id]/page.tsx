...
export default async function InternalProfilePage({ params, searchParams }: PageProps) {
    ...
    const calculateExp = (exps: any[]) => {
        // ... implementation (same as before, or simplified since we have years)
    ...
    return (
        <div className="min-h-screen bg-slate-950 text-cyan-500 font-mono p-6">
            ...
            <div className="flex justify-between items-center mb-8 border-b border-cyan-900/50 pb-4">
                <Link href="/search?mode=internal" className="text-sm hover:text-cyan-300 transition-colors">
                    [ &lt; BACK ]
                </Link>
